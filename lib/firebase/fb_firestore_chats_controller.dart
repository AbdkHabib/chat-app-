...
class FbFireStoreChatsController with FbHelper {
  ...
  // Stream<QuerySnapshot<Chat>> fetchChats(String chatStatus,
  //     [String createdBy = '']) async* {
  //   final collectionReference = _firestore.collection("Chats").where("peers",
  //       arrayContainsAny: [myID]).where("chat_status", isEqualTo: chatStatus);
  //   // .orderBy('last_message_time', descending: true);
  //   // collectionReference.where("chat_status", isEqualTo: chatStatus);
  //   collectionReference.orderBy('last_message_time', descending: true);
  ...
  //       .snapshots();
  // }
  // .where("created_by", isNotEqualTo: createdBy)
